...
<body>
    ...
    <main class="px-4 lg:px-0 max-w-screen-xl mx-auto mt-5">
        <div class="grid grid-cols-12 gap-x-0 lg:gap-x-20">
                                ...
                                <div class="flex items-center gap-x-4 mt-4">
                                    <label for="dine-in" id="dine-in-label" class="py-5 px-6 flex border border-2 border-blue-400 justify-between items-center bg-white rounded-xl w-full cursor-pointer">
                                        <div class="flex items-center gap-x-3 font-medium">
                                            <span>
                                                <svg class="w-8 h-8 md:w-9 md:h-9" xmlns="http://www.w3.org/2000/svg" width="655.359" height="655.359" fill-rule="evenodd" clip-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" viewBox="0 0 6.827 6.827" id="dining-table">
                                    ...
                                    <label for="take-away" id="take-away-label" class="py-5 px-6 flex justify-between items-center border border-2 bg-white rounded-xl w-full cursor-pointer">
                                        <div class="flex items-center gap-x-3 font-medium">
                                            <span>
                                                <svg class="w-8 h-8 md:w-9 md:h-9" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 512 512" viewBox="0 0 512 512" id="food-delivery">
