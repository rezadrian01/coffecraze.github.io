    ...
    <div class="flex justify-center h-screen">
        <div class="w-1/4">
            ...
            <div class="flex flex-col py-2 px-3 border-2 rounded-2xl transition hover:border-gray-400 mb-4">
                ...
                <input id="username" type="text" class="text-sm outline-none" placeholder="Username">
            </div>
            ...
            <button class="py-2.5 w-full bg-[#723E29] text-base text-white font-medium rounded-full mt-7">Sign up</button>
