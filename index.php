            ...
            <main class="grow py-2.5 px-4 md:px-6 xl:px-12 2xl:px-16">
                <div class="flex justify-between items-center mt-3 mb-8">
                    <div class="flex items-center gap-x-2">
                        ...
                        <button class="py-2 px-4 rounded-full text-sm text-white font-semibold bg-[#8d6e63]">
                            Espresso
                        </button>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-6 gap-6 gap-6">
                    <div onclick="showModal()">
                        <div class="h-80 w-full">
                            <img class="h-full w-full rounded-2xl object-cover" src="./assets/coffee-image.jpg" alt="coffee">
                        </div>
                        ...
                        <div class="flex justify-between items-center mt-1">
                            ...
                            <div>
                                ...
                                <h6 class="font-bold text-xl text-[#3e2723]">Caffè latte</h6>
                            </div>
                        ...
                        <div class="flex justify-between items-center mt-1">
                            <h6 class="text-lg font-bold">Rp8.000</h6>
                        </div> 
