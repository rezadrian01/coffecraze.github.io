            ...
            <div class="mt-6">
                <form action="produk_tambah.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col py-2 px-3 border-2 rounded-2xl transition hover:border-gray-400 mb-4">
                        ...
                        <input id="nama_product" type="text" name="nama" class="text-sm outline-none" placeholder="Nama product">
                    </div>
                    ...
                    <div class="flex flex-col py-2 px-3 border-2 rounded-2xl transition hover:border-gray-400 mb-4">
                        ...
                        <div class="flex items-center gap-x-2">
                            ...
                            <input id="harga" type="number" name="harga" class="text-sm outline-none w-full" placeholder="000.000">
                        </div>
                    </div>
                        ...
                        <select id="kategori" name="kategori" class="outline-none border-0 text-sm capitalize" placeholder="Pilih kategori">
                            <?php
                                ...
                                foreach($dataArray as $data) {
                                    echo "<option class='capitalize' value='{$data['id']}'>{$data['nama']}</option>";
                                }
                            ?>
                        </select>
                    </div>
                    ...
                    <div class="flex flex-col py-2 px-3 border-2 rounded-2xl transition hover:border-gray-400">
                        ...
                        <textarea id="deskripsi" name="deskripsi" cols="30" rows="3" class="outline-none text-sm" placeholder="Deskripsi"></textarea>
                    </div>
                    ...
                    <div class="flex justify-end gap-x-2 mt-8">
                        ...
                        <button name="submit-tambah-produk" type="submit" class="py-2.5 px-5 text-sm font-medium rounded-full bg-[#2196f3] text-white">Submit</button>
                    </div>
                </form>
            </div>
        </main>
